...
def spawn_right_turn_symbol(shape, actor_ids, face_origin, heading):
    """Black curved right-turn warning symbol."""
...
def spawn_right_turn_warning_sign(
    shape,
    actor_ids,
    ground_location,
    heading=0.0,
    ...
    spawn_right_turn_symbol(shape, actor_ids, face_origin, heading)
...
def main():
    ...
    print("Triangular Right-Turn warning sign v2 created.")
