...
# ================================================================
# U-Turn traffic sign - Plane test
# ================================================================
# Blue circular mandatory-style plate + white U-turn arrow.
# The arrow is built with the same approved multi-box method used for the
# other custom signs: many short cubes for curves and a filled arrowhead.
# ================================================================
...
def spawn_u_turn_symbol(shape, actor_ids, face_origin, heading):
    """White U-turn arrow with more balanced tail/head proportions."""
    ...
    draw_polyline(shape, actor_ids, face_origin, heading, stem, color=WHITE)

    # Top half-circle turning toward the left.
    u_arc = arc_points(
        center_x=-0.02,
        center_y=0.14,
        radius=0.14,
    ...
    draw_polyline(shape, actor_ids, face_origin, heading, u_arc, color=WHITE)
    ...
    draw_polyline(shape, actor_ids, face_origin, heading, return_leg, color=WHITE)
...
def spawn_u_turn_sign(shape, actor_ids, ground_location, heading=0.0):
    ...
    spawn_u_turn_symbol(shape, actor_ids, face_origin, heading)


def main():
    print("Open the QLabs Plane workspace before running this script.")
    print("This test builds a U-Turn sign using multi-box custom geometry.")
    ...
    print("U-Turn traffic sign created.")
