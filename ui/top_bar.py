...
class TopControlBar(QWidget):
    ...
    def _build_settings_row(self):
        ...
        self.workspace_show_road_checkbox.setToolTip("Show workspace road reference")
        ...
        self.workspace_show_nav_checkbox.setToolTip("Show workspace navigation reference")
